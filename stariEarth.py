...
use_print_prog = True
use_print_delta = True ### MODIFIED ###
print_prog_num = 500  # print the progress every x steps
dttry = 1.E-10
trun_min = 1e2
runtime = 1.E22
dt_min = 1.E-16       ### MODIFIED ###
dt_max = runtime*1e-5
dt_var_max = 1.2      ### MODIFIED ###
dt_var_min = 0.1      ### MODIFIED ###
count_min = 120
count_max = int(5E4) ### MODIFIED ###
atol = 1.E-2          ### MODIFIED ###
mtol = 1.E-22
mtol_conv = 1.E-16
pos_cut = 1.E-30      ### MODIFIED ###
nega_cut = -1.E-2     ### MODIFIED ###
loss_eps = 1e7        ### MODIFIED ###
...
# =============================================================================
rtol = 1.E-5          ### MODIFIED ###
post_conden_rtol = 1.E-4 ### MODIFIED ###
